...
const Landing = () => {
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative px-6 lg:px-8 pt-32 pb-20 md:pt-40 md:pb-28 animated-background">
        {/* Animated blob effects */}
        <div className="blob bg-blue-200" style={{ width: '300px', height: '300px', top: '20%', right: '10%' }}></div>
        <div className="blob bg-indigo-100" style={{ width: '500px', height: '500px', top: '10%', left: '5%' }}></div>
        <div className="blob bg-purple-100" style={{ width: '400px', height: '400px', bottom: '5%', right: '20%' }}></div>
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)] -z-10"></div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            >
              <span className="animated-text-gradient">Empower</span> Your Learning Journey
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link to="/seneca">
                <Button size="lg" className="bg-indigo-600 hover:bg-indigo-500 shadow-md button-hover-effect animate-pulse-glow">
                  Get Started
                </Button>
              </Link>
              <Button variant="ghost" size="lg" className="animated-button">
                Learn more →
              </Button>
            </motion.div>
            ...
            <motion.div
              ...
              className="mt-16 max-w-5xl mx-auto animate-float"
            >
      ...
      {/* Features Section */}
      <section className="py-24 bg-white features-bg">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-16">
            ...
            >
              Our comprehensive suite of tools is designed to help you master any subject with ease.
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="relative p-8 bg-white rounded-2xl shadow-sm border border-gray-100 hover:border-indigo-100 hover:shadow-md transition-all feature-card"
              >
      ...
      <section className="py-24 bg-gray-50 relative">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,#000_60%,transparent_100%)] -z-10"></div>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {pricingPlans.map((plan, index) => (
              ...
              >
                ...
                } ${plan.featured ? 'animate-pulse-glow' : ''}`}>
                  {plan.featured && (
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="rounded-2xl bg-gradient-to-r from-indigo-50 to-blue-50 p-8 md:p-12 relative overflow-hidden"
          >
            {/* Animated background elements */}
            <div className="blob bg-blue-100" style={{ width: '300px', height: '300px', top: '-10%', left: '5%', opacity: '0.4' }}></div>
            <div className="blob bg-indigo-100" style={{ width: '200px', height: '200px', bottom: '-5%', right: '10%', opacity: '0.3' }}></div>
            ...
            <div className="mx-auto max-w-2xl text-center relative z-10">
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.2 }}
                className="mt-8 flex max-w-md mx-auto items-center gap-x-4"
              >
                <Input
                  type="email"
                ...
                />
                <Button className="bg-indigo-600 hover:bg-indigo-500 button-hover-effect">
                  Subscribe
                </Button>
              </motion.div>
            </div>
